...
def main(llm='gpt3.5', port=10049, prompt_path=None, max_users=2, share=False):
    ...
    with gr.Blocks() as demo:
        ...
        txt_msg = txt.submit(add_text, [chatbot, txt], [chatbot, txt], queue=False).then(
            bot, [chatbot, state, allowed], [chatbot, state]
        )
    ...
    demo.queue(concurrency_count=max_users).launch(server_port=port, share=share)
